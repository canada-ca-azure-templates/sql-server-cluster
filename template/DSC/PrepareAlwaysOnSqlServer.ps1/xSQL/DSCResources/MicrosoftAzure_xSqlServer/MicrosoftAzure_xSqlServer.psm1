...
function Set-TargetResource
{
    ...
    if ($ServiceCredential)
    {
        ...
        Write-Verbose "Calling Update-SpnPermissions.  serviceCred: $($ServiceCredential.UserName) $($ServiceCredential.Password).  DomainCred $($DomainAdministratorCredential.UserName) $($DomainAdministratorCredential.Passwor)"
    ...
    Write-Verbose "Getting system credential for NT Authority\system"
...
function Set-ServiceAccount([PSCredential]$Credential, [string]$InstanceName, [Microsoft.SqlServer.Management.Smo.Server]$Server)
{
    ...
    Write-Verbose "Set-ServiceAccount....remove SPNs....$($mc.Name)"
